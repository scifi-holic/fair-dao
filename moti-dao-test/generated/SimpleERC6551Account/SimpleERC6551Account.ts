...
export class SimpleERC6551Account__tokenResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
...
export class SimpleERC6551Account extends ethereum.SmartContract {
  static bind(address: Address): SimpleERC6551Account {
    return new SimpleERC6551Account("SimpleERC6551Account", address);
  }
  ...
  token(): SimpleERC6551Account__tokenResult {
    let result = super.call("token", "token():(uint256,address,uint256)", []);

    return new SimpleERC6551Account__tokenResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
    );
  ...
  try_token(): ethereum.CallResult<SimpleERC6551Account__tokenResult> {
    let result = super.tryCall(
      "token",
    ...
    return ethereum.CallResult.fromValue(
      new SimpleERC6551Account__tokenResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
      ),
